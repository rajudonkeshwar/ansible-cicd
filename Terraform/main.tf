...
resource "aws_key_pair" "Key-Pair" {
  ...
  public_key = "ssh-rsa  pc@DESKTOP-2FT8LSI"
...
resource "aws_security_group" "JENKINS-SG" {
  ...
  egress {
    ...
    from_port   = 0
    to_port     = 0
    protocol    = "-1" #rule apply to all protocols
    cidr_blocks = ["0.0.0.0/0"]
  }
}
